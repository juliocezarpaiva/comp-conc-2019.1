    ...
    int main(int argc, char *argv[])
    {
        ...
        {            
            ...
            tid_sistema = (pthread_t *) malloc(sizeof(pthread_t) * aux);
            ...
            printf("Tempo impressao: %.8lf\n", delta3);
            printf("Tempo finalizacoes: %.8lf\n", delta4);
            
            //double speedup = 1/(p + ((1-p)/nthreads));
            double fulltime = delta1 + delta2 + delta3 + delta4;
